...
pytest-coverage args="":
    .venv/bin/pytest tests --color=yes --cov=src --cov-fail-under=5 --cov-report html:var/coverage/html --cov-report xml:var/coverage/pytest-cobertura.xml --cov-report term-missing --junit-xml='var/coverage/pytest-junit.xml' {{args}}
